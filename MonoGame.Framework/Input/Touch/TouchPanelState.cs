...
namespace Microsoft.Xna.Framework.Input.Touch
{
    public class TouchPanelState
    {
        ...
        public TouchCollection GetState()
        {
            ...
            {
                TouchLocation touch = _touchState[i];
            ...
            TouchCollection result = (_touchState.Count > 0) ? new TouchCollection(_touchState.ToArray()) : TouchCollection.Empty;
        ...
        internal void AddEvent(int id, TouchLocationState state, Vector2 position, bool isMouse)
        {
            ...
            if (!isMouse || EnableMouseTouchPoint || EnableMouseGestures)
            {
                ...
                TouchLocation evt = new TouchLocation(touchId, state, position * _touchScale, CurrentTimestamp);
        ...
        /// </summary>
        public DisplayOrientations DisplayOrientation { get; set; }
