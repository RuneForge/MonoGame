...
namespace Microsoft.Xna.Framework
{
    ...
    public abstract class GameWindow
    {
        ...
        internal bool m_allowAltF4 = true;
        internal MouseState m_mouseState;
        internal TouchPanelState m_touchPanelState;
        ...
        /// </summary>
        public abstract DisplayOrientations CurrentOrientation { get; }
...
#if DESKTOPGL || (WINDOWS && !WINDOWS_UAP)
        ...
        {
            m_touchPanelState = new TouchPanelState(this);
        }
        ...
        {
            get { return m_allowAltF4; }
            set { m_allowAltF4 = value; }
        }
        ...
        internal bool HandleTextInput
        {
            get { return TextTyped != null; }
        }
        ...
        /// </remarks>
        public event EventHandler<TextTypedEventArgs> TextTyped;
        ...
        protected abstract void OnBeforeTitleSet(string title);
        ...
        protected internal abstract void SetSupportedOrientations(DisplayOrientations orientations);
        ...
        /// <summary>
        /// Called when the window receives text input. Raises the <see cref="TextTyped"/> event.
        /// </summary>
        /// <param name="e">Parameters to the <see cref="TextTyped"/> event.</param>
        internal void OnTextTyped(TextTypedEventArgs e)
        {
            EventHelpers.Raise(this, TextTyped, e);
        }
